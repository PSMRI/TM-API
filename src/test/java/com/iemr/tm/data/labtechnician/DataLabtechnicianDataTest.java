 ...
 * {@code com.iemr.tm.data.labtechnician}.
 */
@DisplayName("com.iemr.tm.data.labtechnician data classes")
class DataLabtechnicianDataTest {
	...
	List<DynamicTest> dataClassesShouldRoundTripProperties() {
		return PojoTestSupport.accessorTestsFor("com.iemr.tm.data.labtechnician");
	}
}
