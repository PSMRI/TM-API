 ...
 * {@code com.iemr.tm.data.registrar}.
 */
@DisplayName("com.iemr.tm.data.registrar data classes")
class DataRegistrarDataTest {
	...
	List<DynamicTest> dataClassesShouldRoundTripProperties() {
		return PojoTestSupport.accessorTestsFor("com.iemr.tm.data.registrar");
	}
}
