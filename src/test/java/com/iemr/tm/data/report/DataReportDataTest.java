...
*/
package com.iemr.tm.data.report;
 ...
 * {@code com.iemr.tm.data.report}.
 */
@DisplayName("com.iemr.tm.data.report data classes")
class DataReportDataTest {
	...
	List<DynamicTest> dataClassesShouldRoundTripProperties() {
		return PojoTestSupport.accessorTestsFor("com.iemr.tm.data.report");
	}
}
