 ...
 * {@code com.iemr.tm.data.benFlowStatus}.
 */
@DisplayName("com.iemr.tm.data.benFlowStatus data classes")
class DataBenFlowStatusDataTest {
	...
	List<DynamicTest> dataClassesShouldRoundTripProperties() {
		return PojoTestSupport.accessorTestsFor("com.iemr.tm.data.benFlowStatus");
	}
}
