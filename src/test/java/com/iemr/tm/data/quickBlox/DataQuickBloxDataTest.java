 ...
 * {@code com.iemr.tm.data.quickBlox}.
 */
@DisplayName("com.iemr.tm.data.quickBlox data classes")
class DataQuickBloxDataTest {
	...
	List<DynamicTest> dataClassesShouldRoundTripProperties() {
		return PojoTestSupport.accessorTestsFor("com.iemr.tm.data.quickBlox");
	}
}
