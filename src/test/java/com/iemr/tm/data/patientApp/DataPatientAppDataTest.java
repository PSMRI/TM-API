...
*/
package com.iemr.tm.data.patientApp;
 ...
 * {@code com.iemr.tm.data.patientApp}.
 */
@DisplayName("com.iemr.tm.data.patientApp data classes")
class DataPatientAppDataTest {
	...
	List<DynamicTest> dataClassesShouldRoundTripProperties() {
		return PojoTestSupport.accessorTestsFor("com.iemr.tm.data.patientApp");
	}
}
