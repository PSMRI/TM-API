 ...
 * {@code com.iemr.tm.data.anc}.
 */
@DisplayName("com.iemr.tm.data.anc data classes")
class DataAncDataTest {
	...
	List<DynamicTest> dataClassesShouldRoundTripProperties() {
		return PojoTestSupport.accessorTestsFor("com.iemr.tm.data.anc");
	}
}
