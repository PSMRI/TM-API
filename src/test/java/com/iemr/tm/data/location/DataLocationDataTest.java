 ...
 * {@code com.iemr.tm.data.location}.
 */
@DisplayName("com.iemr.tm.data.location data classes")
class DataLocationDataTest {
	...
	List<DynamicTest> dataClassesShouldRoundTripProperties() {
		return PojoTestSupport.accessorTestsFor("com.iemr.tm.data.location");
	}
}
