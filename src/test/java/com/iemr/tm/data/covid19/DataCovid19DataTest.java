 ...
 * {@code com.iemr.tm.data.covid19}.
 */
@DisplayName("com.iemr.tm.data.covid19 data classes")
class DataCovid19DataTest {
	...
	List<DynamicTest> dataClassesShouldRoundTripProperties() {
		return PojoTestSupport.accessorTestsFor("com.iemr.tm.data.covid19");
	}
}
