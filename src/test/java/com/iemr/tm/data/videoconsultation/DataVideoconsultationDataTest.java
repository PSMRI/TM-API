 ...
 * {@code com.iemr.tm.data.videoconsultation}.
 */
@DisplayName("com.iemr.tm.data.videoconsultation data classes")
class DataVideoconsultationDataTest {
	...
	List<DynamicTest> dataClassesShouldRoundTripProperties() {
		return PojoTestSupport.accessorTestsFor("com.iemr.tm.data.videoconsultation");
	}
}
