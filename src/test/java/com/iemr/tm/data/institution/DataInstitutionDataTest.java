 ...
 * {@code com.iemr.tm.data.institution}.
 */
@DisplayName("com.iemr.tm.data.institution data classes")
class DataInstitutionDataTest {
	...
	List<DynamicTest> dataClassesShouldRoundTripProperties() {
		return PojoTestSupport.accessorTestsFor("com.iemr.tm.data.institution");
	}
}
