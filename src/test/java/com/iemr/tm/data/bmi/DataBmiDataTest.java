 ...
 * {@code com.iemr.tm.data.bmi}.
 */
@DisplayName("com.iemr.tm.data.bmi data classes")
class DataBmiDataTest {
	...
	List<DynamicTest> dataClassesShouldRoundTripProperties() {
		return PojoTestSupport.accessorTestsFor("com.iemr.tm.data.bmi");
	}
}
