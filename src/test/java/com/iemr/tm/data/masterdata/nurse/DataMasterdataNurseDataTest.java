 ...
 * {@code com.iemr.tm.data.masterdata.nurse}.
 */
@DisplayName("com.iemr.tm.data.masterdata.nurse data classes")
class DataMasterdataNurseDataTest {
	...
	List<DynamicTest> dataClassesShouldRoundTripProperties() {
		return PojoTestSupport.accessorTestsFor("com.iemr.tm.data.masterdata.nurse");
	}
}
