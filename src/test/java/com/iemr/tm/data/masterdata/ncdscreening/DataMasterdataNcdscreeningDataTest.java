 ...
 * {@code com.iemr.tm.data.masterdata.ncdscreening}.
 */
@DisplayName("com.iemr.tm.data.masterdata.ncdscreening data classes")
class DataMasterdataNcdscreeningDataTest {
	...
	List<DynamicTest> dataClassesShouldRoundTripProperties() {
		return PojoTestSupport.accessorTestsFor("com.iemr.tm.data.masterdata.ncdscreening");
	}
}
