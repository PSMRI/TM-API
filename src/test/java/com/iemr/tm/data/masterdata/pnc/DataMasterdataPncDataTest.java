 ...
 * {@code com.iemr.tm.data.masterdata.pnc}.
 */
@DisplayName("com.iemr.tm.data.masterdata.pnc data classes")
class DataMasterdataPncDataTest {
	...
	List<DynamicTest> dataClassesShouldRoundTripProperties() {
		return PojoTestSupport.accessorTestsFor("com.iemr.tm.data.masterdata.pnc");
	}
}
