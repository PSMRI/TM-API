 ...
 * {@code com.iemr.tm.data.masterdata.doctor}.
 */
@DisplayName("com.iemr.tm.data.masterdata.doctor data classes")
class DataMasterdataDoctorDataTest {
	...
	List<DynamicTest> dataClassesShouldRoundTripProperties() {
		return PojoTestSupport.accessorTestsFor("com.iemr.tm.data.masterdata.doctor");
	}
}
