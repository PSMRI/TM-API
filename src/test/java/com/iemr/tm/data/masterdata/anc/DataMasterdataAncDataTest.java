 ...
 * {@code com.iemr.tm.data.masterdata.anc}.
 */
@DisplayName("com.iemr.tm.data.masterdata.anc data classes")
class DataMasterdataAncDataTest {
	...
	List<DynamicTest> dataClassesShouldRoundTripProperties() {
		return PojoTestSupport.accessorTestsFor("com.iemr.tm.data.masterdata.anc");
	}
}
