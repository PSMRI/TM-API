 ...
 * {@code com.iemr.tm.data.masterdata.registrar}.
 */
@DisplayName("com.iemr.tm.data.masterdata.registrar data classes")
class DataMasterdataRegistrarDataTest {
	...
	List<DynamicTest> dataClassesShouldRoundTripProperties() {
		return PojoTestSupport.accessorTestsFor("com.iemr.tm.data.masterdata.registrar");
	}
}
