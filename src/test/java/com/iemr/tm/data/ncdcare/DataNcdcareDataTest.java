...
*/
package com.iemr.tm.data.ncdcare;
 ...
 * {@code com.iemr.tm.data.ncdcare}.
 */
@DisplayName("com.iemr.tm.data.ncdcare data classes")
class DataNcdcareDataTest {
	...
	List<DynamicTest> dataClassesShouldRoundTripProperties() {
		return PojoTestSupport.accessorTestsFor("com.iemr.tm.data.ncdcare");
	}
}
