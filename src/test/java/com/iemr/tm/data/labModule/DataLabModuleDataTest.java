 ...
 * {@code com.iemr.tm.data.labModule}.
 */
@DisplayName("com.iemr.tm.data.labModule data classes")
class DataLabModuleDataTest {
	...
	List<DynamicTest> dataClassesShouldRoundTripProperties() {
		return PojoTestSupport.accessorTestsFor("com.iemr.tm.data.labModule");
	}
}
