 ...
 * {@code com.iemr.tm.data.foetalmonitor}.
 */
@DisplayName("com.iemr.tm.data.foetalmonitor data classes")
class DataFoetalmonitorDataTest {
	...
	List<DynamicTest> dataClassesShouldRoundTripProperties() {
		return PojoTestSupport.accessorTestsFor("com.iemr.tm.data.foetalmonitor");
	}
}
