...
*/
package com.iemr.tm.data.nurse;
 ...
 * {@code com.iemr.tm.data.nurse}.
 */
@DisplayName("com.iemr.tm.data.nurse data classes")
class DataNurseDataTest {
	...
	List<DynamicTest> dataClassesShouldRoundTripProperties() {
		return PojoTestSupport.accessorTestsFor("com.iemr.tm.data.nurse");
	}
}
