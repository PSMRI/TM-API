 ...
 * {@code com.iemr.tm.data.doctor}.
 */
@DisplayName("com.iemr.tm.data.doctor data classes")
class DataDoctorDataTest {
	...
	List<DynamicTest> dataClassesShouldRoundTripProperties() {
		return PojoTestSupport.accessorTestsFor("com.iemr.tm.data.doctor");
	}
}
