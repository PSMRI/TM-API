...
*/
package com.iemr.tm.data.snomedct;
 ...
 * {@code com.iemr.tm.data.snomedct}.
 */
@DisplayName("com.iemr.tm.data.snomedct data classes")
class DataSnomedctDataTest {
	...
	List<DynamicTest> dataClassesShouldRoundTripProperties() {
		return PojoTestSupport.accessorTestsFor("com.iemr.tm.data.snomedct");
	}
}
